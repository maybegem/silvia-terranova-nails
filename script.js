...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // 3. Modal Lightbox Ingrandimento Foto
      ...
      if (img && modal && modalBody) {
        modalBody.innerHTML = `
          <div style="position: relative; background: #FFF;">
            <img src="${img.src}" alt="${title}" style="width: 100%; max-height: 75vh; object-fit: contain; background: #F7EBE8;">
            <div style="padding: 20px; text-align: center;">
              ...
              <a href="https://ig.me/m/silvia_terranova_nailartist" target="_blank" rel="noopener" class="btn btn-primary btn-sm">
                Richiedi un Trattamento Simile in Direct
              </a>
            </div>
          </div>
        `;
